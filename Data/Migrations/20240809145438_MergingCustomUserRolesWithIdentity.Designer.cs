...
namespace ProgramPlatform.Data.Migrations
{
    ...
    [Migration("20240809145438_MergingCustomUserRolesWithIdentity")]
    partial class MergingCustomUserRolesWithIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProgramPlatform.Models.DeviceModel", b =>
                {
                    ...
                    b.Property<Guid>("SimCardNetworkId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgramPlatform.Models.DeviceModel", b =>
                {
                    b.HasOne("ProgramPlatform.Models.SimNetworkModel", "SimCardNetwork")
                        .WithMany()
                        .HasForeignKey("SimCardNetworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
